...
-(void)drawRect:(CGRect)rect {
    if(self.badgeValue != 0 || self.displayWhenZero) {
        ...
        {
            NSString *str=@"99+";
            [[NSString stringWithFormat:@"%@", str] drawInRect:CGRectMake(self.outlineWidth + 3, (rect.size.height / 2.0) - (numberSize.height / 2.0), rect.size.width - (self.outlineWidth * 2) - 6, numberSize.height) withFont:self.font lineBreakMode:UILineBreakModeClip alignment:UITextAlignmentCenter];
        }
