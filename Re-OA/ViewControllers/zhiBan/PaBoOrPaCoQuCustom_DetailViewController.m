...
#import "paBoOrPaCoQuCustom_detailCell.h"
#import "ZhiBanWebAPI.h"
#import "MJRefresh.h"
#import "AlertHelper.h"
#define tittleWidth 2670
@interface PaBoOrPaCoQuCustom_DetailViewController ()<UITableViewDataSource,UITableViewDelegate,UIScrollViewDelegate,getTimeDelegate>
{
    NSMutableArray *dataArr;
    UIScrollView *rightScrollView;
    UITableView *rightTableView;
    paBoOrPaCoQuCustom_detailTittleView *view2;
    NSString *  maxid;
...
@implementation PaBoOrPaCoQuCustom_DetailViewController
...
- (void)viewDidLoad {
    ...
    view2 = [[paBoOrPaCoQuCustom_detailTittleView alloc]instanceChooseView];
    view2.delegate=self;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    paBoOrPaCoQuCustom_detailCell *cell = [tableView dequeueReusableCellWithIdentifier:identfier];
    if (!cell) {
        cell = [[[NSBundle mainBundle] loadNibNamed:@"paBoOrPaCoQuCustom_detailCell" owner:self options:nil] lastObject];
