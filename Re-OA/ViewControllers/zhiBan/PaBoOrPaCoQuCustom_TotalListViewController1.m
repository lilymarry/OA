//
//  PaBoOrPaCoQuCustom_TotalListViewController1.m
//  Re-OA
//
//  Created by imac-1 on 2017/2/16.
...
#import "paBoOrPaCoQuCustom_TotalListCell1.h"
#import "PaBoOrPaCoQuCustom_DetailViewController1.h"
#import "ZhiBanWebAPI.h"
//#import "MJRefresh.h"
#import "AlertHelper.h"
#define tittleWidth 2420
@interface PaBoOrPaCoQuCustom_TotalListViewController1 ()<UITableViewDataSource,UITableViewDelegate,UIScrollViewDelegate,getTimeDelegate>
{
    NSMutableArray *dataArr;
    UIScrollView *rightScrollView;
    UITableView *rightTableView;
    PaBoOrPaCoQuTittleView1 *view2;
    NSString *  maxid;
    NSString *  time;
}
@end

@implementation PaBoOrPaCoQuCustom_TotalListViewController1
...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    [ZhiBanWebAPI ReportDayOrderWithSearchDate:_dateStr   yw:_yw success:^(NSArray *arr){
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    paBoOrPaCoQuCustom_TotalListCell1 *cell = [tableView dequeueReusableCellWithIdentifier:identfier];
    if (!cell) {
        cell = [[[NSBundle mainBundle] loadNibNamed:@"paBoOrPaCoQuCustom_TotalListCell1" owner:self options:nil] lastObject];
    ...
    if ([_quanXianId1 isEqualToString:@"ywymrdd"]) {
        cell.lab_Amount.text=@"无权限";
        cell.lab_TwoLayersAmount.text=@"无权限";
        cell.lab_SinglePitAmount.text=@"无权限";
        cell.lab_DoublePitAmount.text=@"无权限";
        cell.lab_ThreePitAmount.text=@"无权限";
    }
    else
    {
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    PaBoOrPaCoQuCustom_DetailViewController1 *changyongController = [s instantiateViewControllerWithIdentifier:@"PaBoOrPaCoQuCustom_Detail1"];
    changyongController.CustomNum=model.CustomCode;
    changyongController.dateStr=_dateStr;
    changyongController.quanXianId1=_quanXianId1;
    changyongController.CustomNam=model.Abbreviation;
