#import "AddShangBaoViewController1.h"
...
#import "Location.h"
#import <BMapKit.h>
@interface AddShangBaoViewController1 ()<UIImagePickerControllerDelegate,UIActionSheetDelegate,UINavigationControllerDelegate,UITextFieldDelegate,UINavigationBarDelegate>
{
    NSURL *urlPlay;
    BOOL ischooseImg;
...
@implementation AddShangBaoViewController1
...
- (IBAction)approve:(id)sender
{
  ...
  if (lo.length!=0 &&la.length!=0) {
        ...
        [ShangBaoWebAPI approveShangBaoWithUSerID:[UserPermission standartUserInfo].ID
                                           flowId: dic[@"fpId"]
                                             ftyp:dic[@"typeId"]
