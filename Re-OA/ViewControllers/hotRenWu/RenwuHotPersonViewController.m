//
//  RenwuHotPersonViewController.m
//  Re-OA
//
...
@interface RenwuHotPersonViewController ()<UITextFieldDelegate>
{
...
@implementation RenwuHotPersonViewController
...
-(void)getRenWuData
{
    ...
    [HotRewWuWebAPI requestHotUsersByUID:[UserPermission standartUserInfo].ID success:^(NSArray *userList)
     {
         [AlertHelper hideAllHUDsForView:self.view];
         //  NSLog(@"WWW 2 %@",userList);
