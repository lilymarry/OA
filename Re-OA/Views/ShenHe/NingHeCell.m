...
-(void)whenClickImage:(UITapGestureRecognizer *)gestureRecognizer
{
    ...
    if ([self.delegate respondsToSelector:@selector(showZhiLiangDisPlayImageView: andUserId:)]) {
        [self.delegate showZhiLiangDisPlayImageView: self.imageArrs[imgView.tag ] andUserId:userid];
