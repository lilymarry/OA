...
@interface ZhiZhangDetailViewCell : UITableViewCell
@property (weak, nonatomic) IBOutlet UILabel *lab_tit;
@property (weak, nonatomic) IBOutlet UILabel *lab_zhiBanName;
...
@property (weak, nonatomic) IBOutlet UILabel *lab_report;
@property (weak, nonatomic) IBOutlet UILabel *lab_infer;

@property (weak, nonatomic) IBOutlet UILabel *lab_workp;

//@property (weak, nonatomic) IBOutlet UILabel *la_jiagongState;
@property (weak, nonatomic) IBOutlet UILabel *la_jiastate1;
@property (weak, nonatomic) IBOutlet UILabel *la_jiastate2;
@property (weak, nonatomic) IBOutlet UILabel *la_jiastate3;
@property (weak, nonatomic) IBOutlet UILabel *la_jiastate4;
