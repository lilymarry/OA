...
@implementation ShenHeDetailCell
...
-(void)whenClickImage:(UITapGestureRecognizer *)gestureRecognizer
{
    ...
    if ([self.delegate respondsToSelector:@selector(showDisPlayImageView: andUserId:)]) {
        [self.delegate showDisPlayImageView: self.imageArrs[imgView.tag ] andUserId:userid];
